...
## [0.2.1](https://github.com/git-ents/git-metadata/compare/git-metadata-v0.3.0...git-metadata-v0.2.1) (2026-05-17)
...
* Add --file flag and optional --set values to git-ledger ([800e3cf](https://github.com/git-ents/git-metadata/commit/800e3cfc55ce37a93244214bb94a34d9e140d104))
* Add --file flag to create and update commands ([800e3cf](https://github.com/git-ents/git-metadata/commit/800e3cfc55ce37a93244214bb94a34d9e140d104))
...
* Add git-chain crate ([3ffe461](https://github.com/git-ents/git-metadata/commit/3ffe461a336db0e10d7d4c8bdc21ead5646b7d1e))
...
* Add git-ledger and git-chain to workspace ([e79274f](https://github.com/git-ents/git-metadata/commit/e79274fc66a995c1bcf3e269f2fcc21080907e12))
* Add git-ledger crate ([c6d47d0](https://github.com/git-ents/git-metadata/commit/c6d47d077742d622fc9024fdacb5f67e9a9c38c1))
...
* Add log CLI subcommand to git-ledger ([8badb72](https://github.com/git-ents/git-metadata/commit/8badb722fd8ba27a6f1e15b375e53983682f4494))
* Add man generation to CLI ([275207f](https://github.com/git-ents/git-metadata/commit/275207f1b6c7b7aad9bdda1ccfb3b18f2d0fc2ac))
* Add man page generation to all crates and fix CI/CD workflows ([0f3d0ef](https://github.com/git-ents/git-metadata/commit/0f3d0ef8c49793de9b0a751daf345f8b25a4be85))
* Add man page generation to git-ledger and git-chain ([0f3d0ef](https://github.com/git-ents/git-metadata/commit/0f3d0ef8c49793de9b0a751daf345f8b25a4be85))
...
* Implement relation operations in git-metadata ([7f4b5ad](https://github.com/git-ents/git-metadata/commit/7f4b5ad07ae261a7a45f3a99e4be7f3ef780ae86))
...
* Support --set key with empty blob default ([800e3cf](https://github.com/git-ents/git-metadata/commit/800e3cfc55ce37a93244214bb94a34d9e140d104))
...
* Apply clippy suggestions (search_is_some in tests, fmt in main.rs) ([3338eea](https://github.com/git-ents/git-metadata/commit/3338eea1158e2749e105dad0bf385380b6952ae8))
...
* Broaden CD tag regex to match all three crate prefixes ([0f3d0ef](https://github.com/git-ents/git-metadata/commit/0f3d0ef8c49793de9b0a751daf345f8b25a4be85))
...
* CI man job uses checkout@v4 and generates for all crates ([0f3d0ef](https://github.com/git-ents/git-metadata/commit/0f3d0ef8c49793de9b0a751daf345f8b25a4be85))
...
* Handle arbitrary-depth nested fields in ledger tree operations ([55991b9](https://github.com/git-ents/git-metadata/commit/55991b9610eef10d79c8796756442a74cc7efa38))
* Handle slash in link keys and batch prune commits in git-metadata ([15cd0a1](https://github.com/git-ents/git-metadata/commit/15cd0a1a890530e85eca5cd11f697d2b9b17e0ed))
...
* Move project to new repository ([4697dfa](https://github.com/git-ents/git-metadata/commit/4697dfa55a70721ec63c87da208e31a1fbbfe061))
* Nested delete, create consistency, and Box::leak in git-ledger ([c00e676](https://github.com/git-ents/git-metadata/commit/c00e67675717a448003452e627eab5e31096224e))
...
* Replace cargo-binstall with taiki-e/install-action for semver-checks ([fd9c719](https://github.com/git-ents/git-metadata/commit/fd9c719730b71f0ff24a09748c78597550a0ed69))
...
* Use iterative thread walk, normalize message newlines in git-chain ([4db4a14](https://github.com/git-ents/git-metadata/commit/4db4a14e56ed9368a333858b5cf5cd7d768e3def))
* Validate thread root against chain commits, not the repo object database ([d08ddee](https://github.com/git-ents/git-metadata/commit/d08ddee01913ee373a3884e988e5f8bf1371199d))
...
* Add cargo-workspace to release-please ([b4376b0](https://github.com/git-ents/git-metadata/commit/b4376b072dacf50ce23f169ac07016100ddcfbcf))
* Apply lints ([fb0f671](https://github.com/git-ents/git-metadata/commit/fb0f67125ceb48f07ec2b5e2e5431bfa2e781f28))
* Fix Release Please configuration ([14de155](https://github.com/git-ents/git-metadata/commit/14de155a14c14fc2e4673c1a7c357c37a4c7cb6b))
* Move project to new repository ([4ba0cb4](https://github.com/git-ents/git-metadata/commit/4ba0cb49c3b5592da00174050231d1247f0a7f60))
...
* Set release ([146dbfb](https://github.com/git-ents/git-metadata/commit/146dbfbce50f7ec62be9d6ccb63de71923b1906e))
